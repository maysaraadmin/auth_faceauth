...
$string['uploaderror'] = 'An error occurred during the file upload.';
$string['invalidimageformat'] = 'Invalid image format. Only JPEG and PNG are allowed.';
$string['uploadfailed'] = 'Failed to upload the image. Please try again.';
